...
Pour créer une convention appuyer sur le |bouton_3_traits| en bas à droite de l'écran.

Le formulaire à remplir contient les champs suivants :

- **Nom** (obligatoire)

- **Contractant** : à choisir parmi les structures dans |annuaire| > |structures| (ne doit pas nécessairement être un financeur)
...
Cliquer sur |ajout_ligne| pour ajouter une fiche : choisir la fiche a associée et le pourcentage de la fiche financé par la convention. Ce pourcentage sera rapporté au total des dépenses de la fiche et temps passé.
