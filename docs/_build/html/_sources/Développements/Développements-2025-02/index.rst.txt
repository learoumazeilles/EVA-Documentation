...
| Ajout          | Oui                              | Oui                              |
+----------------+----------------------------------+----------------------------------+
| Modification   | Oui MAIS                         | Oui                              |
+----------------+----------------------------------+----------------------------------+
| Suppression    | Oui MAIS                         | Oui                              |
+----------------+----------------------------------+----------------------------------+
...
+----------------+----------------------------------+----------------------------------+
| Suppression    | Oui                              | Oui MAIS                         |
+----------------+----------------------------------+----------------------------------+

MAIS les campagnes n'étant pas reprises au niveau national, le couple mesure cible - mesure réalisé d'une campagne n'est pas associé dans l'instance national donc si on supprime une mesure cible via l'instance nationale il faudra bien supprimer la mesure réalisée aussi ou bien simplement vider les deux valeurs.

Les campagnes n'étant pas reprises au niveau national, il n'est pas possible d'ajouter de nouvelles mesures à des campagnes locales depuis l'instance nationale, uniquement de renseigner les mesures déjà attendues issues de la campagne.
