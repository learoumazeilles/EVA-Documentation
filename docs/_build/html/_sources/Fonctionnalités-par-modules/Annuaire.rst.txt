...
Les emplois peuvent être rajoutés dans la **Liste des emplois**. C'est cette partie qui permet de rattacher les contacts aux structures. **Fonction** doit être définie dans la partie **fonctions** de l'administration : |administration| > |fonctions|. **Structure** doit être définie dans la partie |annuaire| > |structures| au préalable.
...
Les employés peuvent être rajoutés dans la **Liste des employés**. C'est cette partie qui permet de rattacher les contacts aux structures. **Fonction** doit être définie dans la partie **fonctions** de l'administration : |administration| > |fonctions|. **Employé** doit être définie dans la partie |annuaire| > |contacts| au préalable.
